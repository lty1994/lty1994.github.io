  ...
  AV.User = AV.Object.extend(
    ...
    /** @lends AV.User.prototype */ {
      ...
      linkWithWeapp() {
        ...
        return this.associateWithWeapp();
      },
    ...
    /** @lends AV.User */ {
      ...
      /**
       * 使用当前使用小程序的微信用户身份注册或登录，如果用户满足 {@link https://developers.weixin.qq.com/miniprogram/dev/framework/open-ability/union-id.html 获取 UnionId 的条件}，则使用 UnionId 登录
       * 仅在小程序中可用。
       *
       * @since 3.13.0
       * @param {Object} [unionLoginOptions]
       ...
       */
      loginWithWeappWithUnionId(unionLoginOptions) {
        return getWeappLoginCode().then(code =>
          this.loginWithAuthData({ code }, PLATFORM_WEAPP, unionLoginOptions)
        );
      },
